          ...
          {isEditing ? (
            ...
            <>
              <div className={styles.taskHeader}>
                <h1 className={styles.taskName}>{task.task_name || 'N/A'}</h1>
                    ...
                    {task.attachments.map((attachment) => (
                      ...
                      >
                        <div className={styles.attachmentIcon}>
                          <img
                            src={`/assets/icons/${getFileIcon(attachment.name)}.png`}
                            alt="File"
                          />
                        </div>
                        ...
                        <div className={styles.attachmentActions}>
                          ...
                          <button
                            ...
                            title="Xóa"
                            onClick={() => {
                              if (window.confirm('Bạn có chắc muốn xóa tệp này?')) {
                ...
                <div className={styles.assigneeItem}>
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (
                        window.confirm(
                          // `Bạn có chắc muốn xóa ${task.assignee.full_name} khỏi công việc này?`
                        )
                      ) {
                        // onRemoveAssignee(task.assignee.user_id);
                      }
                    }}
                  >
          ...
          <div className={styles.sidebarSection}>
            ...
            <div className={styles.taskInfo}>
              <div className={styles.infoItem}>
                ...
                <span className={styles.infoValue}>{task.created_at || 'N/A'}</span>
              </div>
              <div className={styles.infoItem}>
                <span className={styles.infoLabel}>Cập nhật:</span>
                <span className={styles.infoValue}>{task.updated_at || 'N/A'}</span>
              </div>
            </div>
          </div>
        </div>
